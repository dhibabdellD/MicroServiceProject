# Site de Gestion d'Événements avec Réservations et Sponsors
...
- [Services](#services)
  - [Service de Sponsors (Spring/H2)](#service-de-sponsors-springh2)
  - [Service de Lieux (Spring/SQL)](#service-de-lieux-springsql)
  - [Service d'Événements (Spring/H2)](#service-dévénements-springh2)
  - [Service de Médias (Spring/SQL)](#service-de-médias-springsql)
  - [Service de Réservations (Symfony/PostgreSQL)](#service-de-réservations-symfonypostgresql)
- [Dockerisation avec Docker Compose](#dockerisation-avec-docker-compose)
...
L'architecture du projet est basée sur des microservices interconnectés pour garantir une évolutivité, une flexibilité et une maintenance efficaces.
